...
my $r3 = "UPDATE koha_prod.old_issues SET cle = CONCAT(issuedate, '-', itemnumber) WHERE DATE(returndate) = CURDATE() - INTERVAL 1 DAY" ; # = CURDATE()  - INTERVAL 1 DAY
