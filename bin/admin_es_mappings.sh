...
for index in action_culturelle adherents adherents2015 adherents_synth adherents_tout catalogue documents_synth eliminations entrees freq_etude frequentation inscrits_synth_carte items notices_auth prets prets2 reservations rfid syntheses titres web webkiosk
