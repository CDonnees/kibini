...
get '/grand-plage/inscrits/mois' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Nombre-d\'inscrits-par-mois?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:5,id:\'Nombre-d!\'inscrits-par-mois\',panelIndex:1,row:1,size_x:8,size_y:4,type:visualization),(col:1,id:\'Nombre-d!\'inscrits-par-ville-et-par-mois-(en-%25)\',panelIndex:2,row:5,size_x:12,size_y:5,type:visualization),(col:1,id:\'Nombre-d!\'inscrits-par-%C3%A2ge-et-par-mois-(en-%25)\',panelIndex:3,row:10,size_x:12,size_y:5,type:visualization),(col:1,id:\'Synth%C3%A8se-tableau-:-nombre-d!\'inscrits-par-mois\',panelIndex:4,row:1,size_x:4,size_y:4,type:visualization),(col:1,id:\'Nombre-d!\'inscrits-par-type-de-carte-et-par-mois-(en-%25)\',panelIndex:5,row:15,size_x:12,size_y:5,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Nombre%20d!\'inscrits%20par%20mois\',uiState:(P-2:(vis:(legendOpen:!t)),P-3:(vis:(legendOpen:!t)),P-5:(vis:(legendOpen:!t))))',
            height => '2200px'
        }
    };
};
...
get '/grand-plage/collections/prets' => sub {
    template 'kibana', {
        ...
        label3 => 'Prêts',
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Pr%C3%AAts-Grand-Plage?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-1y,mode:relative,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:Nombre-de-pr%C3%AAts-par-collection,panelIndex:24,row:3,size_x:12,size_y:9,type:visualization),(col:7,id:\'Nombre-d!\'emprunteurs-totaux\',panelIndex:25,row:1,size_x:6,size_y:2,type:visualization),(col:1,id:Pr%C3%AAts,panelIndex:26,row:1,size_x:6,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Pr%C3%AAts%20Grand%20Plage\',uiState:())',
            height => '1400px'
        }
    };
};
...
get '/mediatheque/collections/emprunteurs' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Profil-emprunteurs-m%C3%A9diath%C3%A8que?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:4,id:Emprunteurs-distincts-M%C3%A9diath%C3%A8que,panelIndex:1,row:1,size_x:9,size_y:3,type:visualization),(col:1,id:Emprunteurs-distincts-par-carte-m%C3%A9diath%C3%A8que,panelIndex:2,row:4,size_x:6,size_y:4,type:visualization),(col:7,id:Emprunteurs-distincts-par-%C3%A2ge-m%C3%A9diath%C3%A8que,panelIndex:3,row:4,size_x:6,size_y:4,type:visualization),(col:1,id:\'Nombre-d!\'emprunteurs\',panelIndex:4,row:1,size_x:3,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'pret_site:%20%22M%C3%A9diath%C3%A8que%22\')),title:\'Profil%20emprunteurs%20m%C3%A9diath%C3%A8que\',uiState:())',
            height => '900px'
        }
    };
};
...
get '/mediatheque/collections/prets/totaux' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/A_Pr%C3%AAts-(par-collection)?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-1y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:Nombre-de-pr%C3%AAts,panelIndex:15,row:1,size_x:6,size_y:2,type:visualization),(col:7,id:\'Nombre-d!\'emprunteurs-%C3%A0-la-m%C3%A9diath%C3%A8que\',panelIndex:23,row:1,size_x:6,size_y:2,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-par-collection,panelIndex:24,row:3,size_x:12,size_y:9,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'Personne%20AND%20pret_site:%20%22M%C3%A9diath%C3%A8que%22\')),title:\'A_Pr%C3%AAts%20(par%20collection)\',uiState:())',
            height => '1300px'
        }
    };
};
...
get '/mediatheque/collections/transactions' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/A_Pr%C3%AAts-et-retours-(bornes-m%C3%A9diath%C3%A8que)?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now%2Fy,mode:quick,to:now%2Fy))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:5,id:\'Bornes-RFID-:-retours-par-heure-selon-les-jours-de-la-semaine\',panelIndex:7,row:7,size_x:8,size_y:6,type:visualization),(col:5,id:\'Bornes-RFID-:-pr%C3%AAts-par-heure-selon-les-jours-de-la-semaine\',panelIndex:8,row:1,size_x:8,size_y:6,type:visualization),(col:1,id:\'Bornes-RFID-:-pr%C3%AAts-par-%C3%A9tage\',panelIndex:9,row:4,size_x:4,size_y:3,type:visualization),(col:1,id:\'Bornes-RFID-:-retours-par-%C3%A9tage\',panelIndex:10,row:10,size_x:4,size_y:3,type:visualization),(col:1,id:Pr%C3%AAts-par-jour-de-la-semaine,panelIndex:11,row:1,size_x:4,size_y:3,type:visualization),(col:1,id:Retours-par-jour-de-la-semaine,panelIndex:12,row:7,size_x:4,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'A_Pr%C3%AAts%20et%20retours%20(bornes%20m%C3%A9diath%C3%A8que)\',uiState:(P-10:(vis:(legendOpen:!t)),P-7:(vis:(legendOpen:!f)),P-8:(vis:(legendOpen:!f)),P-9:(vis:(legendOpen:!t))))',
            height => '1350px'
        }
    };
};
...
get '/mediatheque/collections/reservations/utilisateurs' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Profil-des-utilisateurs-du-service-r%C3%A9servations?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:5,id:\'Nombre-d!\'utilisateurs-du-service-r%C3%A9servations-par-type-de-carte\',panelIndex:4,row:5,size_x:4,size_y:4,type:visualization),(col:9,id:\'Nombre-d!\'utilisateurs-du-service-r%C3%A9servations-par-ville\',panelIndex:6,row:5,size_x:4,size_y:4,type:visualization),(col:1,id:\'Nombre-d!\'utilisateurs-du-service-r%C3%A9servations-par-mois\',panelIndex:7,row:1,size_x:8,size_y:4,type:visualization),(col:1,id:R%C3%A9partitions-par-%C3%A2ge,panelIndex:9,row:5,size_x:4,size_y:4,type:visualization),(col:9,id:\'Tableau-nombre-d!\'utilisateurs-distincts-par-mois\',panelIndex:10,row:1,size_x:4,size_y:4,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Profil%20des%20utilisateurs%20du%20service%20r%C3%A9servations\',uiState:(P-4:(vis:(legendOpen:!f)),P-6:(vis:(legendOpen:!f)),P-7:(vis:(legendOpen:!f)),P-9:(vis:(legendOpen:!f))))',
            height => '1000px'
        }
    };
};
...
get '/mediatheque/postes/utilisateurs' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Utilisateurs-de-Webkiosk?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:9,id:Utilisateurs-Webkiosk-par-%C3%A2ge,panelIndex:25,row:4,size_x:4,size_y:4,type:visualization),(col:1,id:Utilisateurs-Webkiosk-par-carte,panelIndex:26,row:4,size_x:4,size_y:4,type:visualization),(col:5,id:Utilisateurs-Webkiosk-par-quartier-de-Roubaix,panelIndex:27,row:4,size_x:4,size_y:4,type:visualization),(col:1,id:\'Nombre-d!\'utilisateurs-distincts-par-mois\',panelIndex:28,row:1,size_x:9,size_y:3,type:visualization),(col:10,id:\'Tableau-nombre-d!\'usagers-distincts-sur-Webkiosk-par-mois\',panelIndex:29,row:1,size_x:3,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Utilisateurs%20de%20Webkiosk\',uiState:(P-25:(vis:(legendOpen:!f)),P-26:(vis:(legendOpen:!f)),P-27:(vis:(legendOpen:!f)),P-28:(vis:(legendOpen:!f))))',
            height => '800px'
        }
    };
};
...
get '/zebre/collections/emprunteurs' => sub {
    template 'kibana', {
        ...
        label3 => 'Profil des emprunteurs',
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Profil-emprunteurs-Z%C3%A8bre?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:Emprunteurs-distincts-par-mois,panelIndex:5,row:1,size_x:9,size_y:3,type:visualization),(col:1,id:Emprunteurs-distincts-par-carte-Z%C3%A8bre,panelIndex:7,row:4,size_x:4,size_y:4,type:visualization),(col:5,id:Emprunteurs-distincts-par-%C3%A2ge-Z%C3%A8bre,panelIndex:8,row:4,size_x:4,size_y:4,type:visualization),(col:9,id:Emprunteurs-distincts-par-quartier-de-Roubaix-Z%C3%A8bre,panelIndex:9,row:4,size_x:4,size_y:4,type:visualization),(col:10,id:\'Nombre-d!\'emprunteurs-Z%C3%A8bre\',panelIndex:10,row:1,size_x:3,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'pret_site:%20%22Z%C3%A8bre%22\')),title:\'Profil%20emprunteurs%20Z%C3%A8bre\',uiState:(P-7:(vis:(legendOpen:!f)),P-8:(vis:(legendOpen:!f)),P-9:(vis:(legendOpen:!f))))',
            height => '900px'
        }
    };
};
...
get '/zebre/collections/prets/details' => sub {
    template 'kibana', {
        ...
        label3 => 'Prêts par semaine et par mois',
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Pr%C3%AAts-Z%C3%A8bre-par-mois-et-semaine?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-2y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:9,id:Nombre-de-pr%C3%AAts-Z%C3%A8bre,panelIndex:1,row:4,size_x:4,size_y:3,type:visualization),(col:9,id:Nombre-de-pr%C3%AAts-par-semaine-Z%C3%A8bre,panelIndex:2,row:1,size_x:4,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-par-mois-Z%C3%A8bre,panelIndex:3,row:4,size_x:8,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-semaine-Z%C3%A8bre,panelIndex:4,row:1,size_x:8,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-adultes-par-mois-et-par-collection-Z%C3%A8bre,panelIndex:5,row:10,size_x:12,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-jeunesse-par-mois-et-par-collection-Z%C3%A8bre,panelIndex:6,row:13,size_x:12,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-par-mois-et-par-collection-Z%C3%A8bre,panelIndex:7,row:7,size_x:12,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-par-mois-et-support-Z%C3%A8bre,panelIndex:8,row:19,size_x:12,size_y:3,type:visualization),(col:1,id:Nombre-de-pr%C3%AAts-patrimoine-par-mois-et-par-collection-Z%C3%A8bre,panelIndex:9,row:16,size_x:12,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Pr%C3%AAts%20Z%C3%A8bre%20par%20mois%20et%20semaine\',uiState:())',
            height => '2350px'
        }
    };
};
