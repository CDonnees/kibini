...
get '/grand-plage/inscrits/profils' => sub {
    template 'kibana', {
        ...
        dashboard => {
            src => 'http://129.1.0.237:5601/app/kibana#/dashboard/Qui-sont-nos-inscrits-questionmark-?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-15y,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:9,id:Inscrits-par-type-de-carte,panelIndex:5,row:6,size_x:4,size_y:4,type:visualization),(col:5,id:Inscrits-totaux-par-sexe,panelIndex:7,row:6,size_x:4,size_y:4,type:visualization),(col:1,id:Inscrits-totaux-par-%C3%A2ge,panelIndex:8,row:6,size_x:4,size_y:4,type:visualization),(col:1,id:Inscrits-totaux,panelIndex:9,row:1,size_x:2,size_y:2,type:visualization),(col:3,id:Inscrits-roubaisiens,panelIndex:10,row:1,size_x:2,size_y:2,type:visualization),(col:5,id:Inscrits-ext%C3%A9rieurs,panelIndex:11,row:1,size_x:2,size_y:2,type:visualization),(col:7,id:\'15-villes\',panelIndex:12,row:1,size_x:3,size_y:2,type:visualization),(col:1,id:\'Nombre-d!\'inscrits-par-mois\',panelIndex:14,row:3,size_x:9,size_y:3,type:visualization),(col:10,id:\'Synth%C3%A8se-tableau-:-nombre-d!\'inscrits-par-mois\',panelIndex:15,row:3,size_x:3,size_y:3,type:visualization),(col:10,id:Inscrits-totaux-par-ville,panelIndex:16,row:1,size_x:3,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:\'*\')),title:\'Qui%20sont%20nos%20inscrits%20%3F\',uiState:(P-14:(vis:(legendOpen:!f)),P-16:(vis:(legendOpen:!f)),P-5:(vis:(legendOpen:!f)),P-7:(vis:(colors:(Femme:%23BF1B00,Homme:%23705DA0),legendOpen:!f)),P-8:(vis:(legendOpen:!f))))',
            height => '1300px'
        }
    };
};
...
get '/mediatheque/services/usages' => sub {
    template 'kibana', {
        label1 => 'La Médiathèque',
        label2 => 'Quelle diversité d\'usages des services ?',
        dashboard => {
            src => '...',
            height => '1200px'
        }
