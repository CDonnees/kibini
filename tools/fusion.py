...
for site in sites:
    file_out = "../data/collections/res/" + site + ".csv"
    
    file_ex = "../data/collections/exemplaires_" + site + ".csv"
    file_el = "../data/collections/eliminations_" + site + ".csv"
    file_pr = "../data/collections/prets_" + site + ".csv"
